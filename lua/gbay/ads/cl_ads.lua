function GBayAdsPageFull(DFrame, data)
	...
	for k, v in pairs(data[6]) do
		if v[3] == "shipments" then
			table.insert(shipids, #shipids + 1, v[4])
		elseif v[3] == "service" then
			table.insert(servids, #servids + 1, v[4])
		elseif v[3] == "entities" then
			table.insert(entids, #entids + 1, v[4])
		end
	end
